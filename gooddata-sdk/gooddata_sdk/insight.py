...
class InsightBucket:
    def __init__(self, bucket: dict[str, Any]) -> None:
        ...
        self.type = _LOCAL_ID_TO_BUCKET_TYPE.get(self.local_id, BucketType.UNDEFINED)
    ...
    def is_empty(self) -> bool:
        return not self.items and not self.totals

    def __str__(self) -> str:
        return self.__repr__()

    def __repr__(self) -> str:
        # TODO: Add totals information to repr
